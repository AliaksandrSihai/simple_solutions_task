    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('USD', 'USD'), ('RUB', 'RUB')], max_length=3, verbose_name='валюта')),
            ],
            options={
                'verbose_name': 'товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to='stripe_shop.discount')),
                ('product', models.ManyToManyField(to='stripe_shop.item')),
                ('tax', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tax', to='stripe_shop.tax')),
            ],
            options={
                'verbose_name': 'заказ',
